...
public class ProductoTable {
    ...
    public static void insertIniciales(SQLiteDatabase db) {
        ...
        Producto p14  = new Producto("Fresas naturales", "La vecina Paca y su marido Eleuterio me ha dado una caja de fresas y no se que hacer con ellas.\n\nMe las iba a comer, pero se estaban poniendo pochas, asi que las he metido en la freidora y ha salido este producto.", 2.45, 50, 0, "https://i.pinimg.com/originals/36/cf/47/36cf476a57516dbeb29e94b26e18cc2c.jpg");
        Producto p15  = new Producto("Oreo", "Croquetas con sabor a ordeo.\n\n*No contiene galletas oro, pues son de Hacendado.", 4.00, 50, 0, "https://3.bp.blogspot.com/-HUTNEbCdpWc/VDLlbz4ymxI/AAAAAAAAPSU/l63CrYnobZs/s1600/DSC_0078.JPG");
