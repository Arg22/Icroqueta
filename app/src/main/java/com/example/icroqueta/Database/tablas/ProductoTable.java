...
public class ProductoTable {
    ...
    public static void insertIniciales(SQLiteDatabase db) {
        ...
        Producto p15  = new Producto("Oreo", "Croquetas con sabor a Oreo.\n\n*No contiene galletas Oreo, más que nada porque están hechas con la imitación de Hacendado.", 4.00, 50, 0, "https://3.bp.blogspot.com/-HUTNEbCdpWc/VDLlbz4ymxI/AAAAAAAAPSU/l63CrYnobZs/s1600/DSC_0078.JPG");
